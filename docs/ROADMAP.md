...
- **OH-23 `planned` → `shipped`** — emailed night-audit intake, Tier 0 row 4.
  ...
  `2026-09-21-oh23-emailed-intake-design.md` (D-OH23.1–9), PR #145. The status is about
